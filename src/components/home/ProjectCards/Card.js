    ...
    <div className="w-80 overflow-hidden h-auto rounded-lg bg-gray-100 dark:bg-gray-800 mb-6 mr-0 md:mb-0 md:mr-6">
      ...
      <div className="p-6">
        ...
        <div className="card-actions flex justify-end">
          <Link
            to={ projectLink }
            className="px-4 py-2 font-medium text-sm border rounded-full text-gray-50 bg-blue-500 hover:bg-blue-600 shadow-sm dark:text-gray-900 dark:bg-blue-300 dark:border-blue-300 border-blue-500 focus:outline-none dark:hover:bg-blue-400">
            View Work
          </Link>
        </div>
      </div>
